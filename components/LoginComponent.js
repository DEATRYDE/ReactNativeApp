...
import { Button, CheckBox, Icon, Image, Input } from "react-native-elements";
import { ImageManipulator, ImagePicker, Permissions, SecureStore } from "expo";
...
class LoginTab extends Component {
  ...
  handleLogin() {
    const { remember, password, username } = this.state;
